...
- **Settings:** Manage settings and hotkeys for the entire app
...
**Sharing routes:** Every route is saved as a `.lua` file in `routes/savedRoutes/`. To share a route, simply send the file to a friend and have them drop it into the same folder.

**Resetting runs:** A custom keybind can be set in the Settings app, letting you reset your run at any time.

**Personal bests:** Your theoretical PB and saved PB splits for each route can be viewed in the Routes app, under the route's Info tab.
